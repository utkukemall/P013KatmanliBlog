    ...
    public partial class VeritabaniKurulumu : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "CreateDate", "Email", "IsActive", "IsAdmin", "Name", "Password", "Phone", "ProfilePhoto", "Surname", "UserGuid", "UserName" },
                values: new object[] { 1, new DateTime(2023, 5, 8, 12, 27, 21, 595, DateTimeKind.Local).AddTicks(1028), "info@P013KatmanliBlog.com", true, true, "Admin", "123", null, null, null, new Guid("e6d67323-a4b0-4ee0-b989-bcec6bdae072"), "Admin" });
